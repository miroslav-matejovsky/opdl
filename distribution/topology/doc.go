...
// Machine names a role and the service groups assigned to it. Together these
// describe the components of a distribution and how they are grouped.
//
...
// and every machine lists at least one service with no duplicates. Validation
