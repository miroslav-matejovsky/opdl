...
//
// NewHandler binds the platform's huma operations (platform/api.Register) through
// the humago adapter. Operation definitions, request decoding, validation, and
// response encoding all belong to huma and platform/api; this package only
// builds the mux, and never learns which transport carries it.
//
