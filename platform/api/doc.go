// Package api is the platform's public HTTP API: the request and response
// types the runtime serves, and the huma operations that serve them.
//
...
// fills, so this package stays free of the event transport.
package api
