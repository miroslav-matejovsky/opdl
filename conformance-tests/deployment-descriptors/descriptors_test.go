...
func TestSignature(t *testing.T) {
	require.Equal(t, "{duration:string,failback_stabilization:string,file:string,health_check_interval:string,lag_bound:string,renewal_interval:string}", signature(reflect.TypeFor[platformconfig.Lease]()))
}
